CREATE TYPE pt.my_role AS ENUM ('owner', 'editor', 'viewer');

CREATE TYPE pt.general_access_level as ENUM ('restricted', 'public');

CREATE TYPE pt.general_access_role as ENUM ('viewer', 'editor');
