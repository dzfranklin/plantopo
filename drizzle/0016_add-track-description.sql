...
--> statement-breakpoint
ALTER TABLE "recorded_track" ADD COLUMN "description" text;--> statement-breakpoint
...
ALTER TABLE "recorded_track_image" ADD CONSTRAINT "recorded_track_image_image_s3_key_image_s3_key_fk" FOREIGN KEY ("image_s3_key") REFERENCES "public"."image"("s3_key") ON DELETE cascade ON UPDATE no action;