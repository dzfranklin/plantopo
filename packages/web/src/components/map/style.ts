...
const OSM_ATTRIB = '<a href="https://www.openstreetmap.org/copyright">&copy; OpenStreetMap</a>';

export const RASTER_BASE_LAYER: LayerSpecification = {
  id: "base",
  type: "raster",
  source: "base",
};

export const SIMPLE_STYLE_LAYER_SPECS: LayerSpecification[] = [
  // Polygons — fill
  {
    id: "geojson-fill",
    type: "fill",
    ...
    paint: {
      ...
      "fill-opacity": [
        "case",
        ["has", "fill-opacity"], ["to-number", ["get", "fill-opacity"]],
        0.6,
      ],
    },
  },
  // Polygons — stroke
  {
    ...
    paint: {
      ...
      "line-opacity": [
        "case",
        ["has", "stroke-opacity"], ["to-number", ["get", "stroke-opacity"]],
        1,
      ],
      "line-width": [
        "case",
        ["has", "stroke-width"], ["to-number", ["get", "stroke-width"]],
        2,
      ],
    },
  },
...
export const THUNDERFOREST_SOURCE: RasterSourceSpecification = {
  type: "raster",
  tiles: [
  ...
  maxzoom: 22,
  attribution:
    '<a href="https://www.thunderforest.com/">&copy; Thunderforest</a>' + ' | ' + OSM_ATTRIB,
};
