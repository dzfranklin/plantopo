...
const defaultSlopeSource: ml.RasterDEMSourceSpecification =
  { ...defaultDEMSource, "tiles": ["https://tile.plantopo.com/slope/{z}/{x}/{y}"], encoding: "mapbox", "minzoom": 9 };

// prettier-ignore
const eduSlopeSource: ml.RasterDEMSourceSpecification =
  { ...eduDEMSource, "tiles": ["https://tile.plantopo.com/edu.slope/{z}/{x}/{y}"], encoding: "mapbox", "minzoom": 9 };
