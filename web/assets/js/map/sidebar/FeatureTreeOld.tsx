...
import { OutdatedFeature, ROOT_FEATURE } from '../features/types';
...
export default function FeatureTreeOld() {
...
const GroupChildren = ({
  ...
  let list: (OutdatedFeature | DragState)[] = [];
  // TODO:
  // if (isExpanded) {
  //   if (dragChild) {
...
const PreviewIcon = ({ feature }: { feature: OutdatedFeature }) => {
