defmodule PlanTopoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PlanTopoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PlanTopoWeb.Gettext, "errors", msg, opts)
    end
  end
