defmodule PlanTopoWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_plan_topo_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule PlanTopoWeb.PageLive do
        use PlanTopoWeb, :live_view

        on_mount {PlanTopoWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PlanTopoWeb.UserAuth, :ensure_authenticated}] do
