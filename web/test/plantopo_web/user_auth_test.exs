defmodule PlanTopoWeb.UserAuthTest do
  use PlanTopoWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias PlanTopo.Accounts
  alias PlanTopoWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PlanTopoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PlanTopoWeb.Endpoint.subscribe(live_socket_id)
