...
//		return Image{}
//	}
//	// TODO: validate this algorithm works and that the images exist
//	aspectRatio := float64(meta.Height) / float64(meta.Width)
//	width := 213
//	height := int(math.Round(float64(width) * aspectRatio))
//	return Image{Width: width, Height: height, Src: imageVariant(secret, meta, "_213x160")}
//}
