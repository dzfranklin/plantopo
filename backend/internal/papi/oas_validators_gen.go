...
func (s *GeosearchGetOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s SearchResultType) Validate() error {
	switch s {
	case "postcode":
		return nil
	case "hill":
...
func (s *SettingsGetOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *SettingsPutOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *SettingsPutReq) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s SettingsUnits) Validate() error {
	switch s {
	case "metric":
		return nil
	case "customary":
...
func (s *Track) Validate() error {
	...
	var failures []validate.FieldError
	if err := func() error {
		if err := (validate.Float{}).Validate(float64(s.LengthMeters)); err != nil {
			return errors.Wrap(err, "float")
		}
		return nil
	}(); err != nil {
...
func (s *TrackSummary) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *TracksGetOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s TracksGetOrderBy) Validate() error {
	switch s {
	case "name":
		return nil
	case "dateAsc":
	...
	case "dateDesc":
		return nil
	case "dateUploadedAsc":
		return nil
	case "dateUploadedDesc":
		return nil
	default:
		return errors.Errorf("invalid value: %v", s)
	}
...
func (s *TracksPostOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *TracksTrackIDGetOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *TracksTrackIDPatchOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
