...
func (s *MunroAccessReportIDStatusGetOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *MunroAccessReportIDStatusGetOKReport) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s MunroAccessReportIDStatusGetOKStatus) Validate() error {
	switch s {
	case "received":
		return nil
	case "working":
