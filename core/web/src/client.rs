...
use plantopo_common::{
    ...
    Aware, ClientId, LInstant, MapId, SmallVec, UserId, Uuid,
};
...
impl Client {
    ...
    pub fn constructor(map_id: &str, client_id: u64, user_id: Option<String>) -> Result<Client> {
        ...
        let inner = common::Client::new(client_id, map_id, rng);
...
fn aware_entry_to_js(entry: &common::Aware) -> Result<Object> {
    let js = Object::new();
