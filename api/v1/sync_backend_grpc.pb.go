...
const (
	...
	SyncBackend_DebugState_FullMethodName      = "/SyncBackend/DebugState"
)
...
type SyncBackendClient interface {
	...
	DebugState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
}
...
func (c *syncBackendClient) DebugState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*wrapperspb.StringValue, error) {
	out := new(wrapperspb.StringValue)
	err := c.cc.Invoke(ctx, SyncBackend_DebugState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SyncBackendServer interface {
	...
	DebugState(context.Context, *emptypb.Empty) (*wrapperspb.StringValue, error)
...
func (UnimplementedSyncBackendServer) DebugState(context.Context, *emptypb.Empty) (*wrapperspb.StringValue, error) {
...
func _SyncBackend_DebugState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SyncBackend_DebugState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SyncBackendServer).DebugState(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
